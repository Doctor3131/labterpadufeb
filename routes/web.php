...
use App\Http\Controllers\Admin\BpsMasterDataController;
use App\Http\Controllers\Admin\BpsSubDataController;
use App\Http\Controllers\Admin\ExternalTransferController;
...
Route::post('/bloomberg/reservasi', [BloombergRequestController::class, 'store'])
    ->middleware('throttle:10,1')
    ->name('bloomberg.store');
Route::get('/bloomberg/walkin', [BloombergRequestController::class, 'createWalkIn'])->name('bloomberg.walkin');
Route::get('/bloomberg/capacity', [BloombergRequestController::class, 'checkCapacity'])->name('bloomberg.capacity');
...
Route::post('/personal-borrowing/validate-nim', [
    PersonalBorrowingController::class,
    'validateNim',
])
...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::patch('/admin/items/{item}/image', [
        ItemController::class,
        'updateImage',
    ])->name('admin.items.update-image');
    Route::delete('/admin/items/{item}/image', [
        ItemController::class,
        'destroyImage',
    ])->name('admin.items.destroy-image');
    ...
    Route::get('/admin/external-transfers', [
        ExternalTransferController::class,
        'index',
