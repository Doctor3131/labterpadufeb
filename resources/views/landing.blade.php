...
<body class="bg-slate-50 text-slate-900 antialiased">
        ...
        <div class="container mx-auto px-4 lg:px-8">
            <div class="flex items-center justify-between h-16 lg:h-20">
                ...
                <a href="{{ route('landing') }}" class="flex items-center space-x-3 group cursor-pointer">
                    <img src="{{ asset('images/LogoUndips.png') }}" alt="Logo Undip"
                        class="h-12 lg:h-16 w-auto object-contain group-hover:scale-105 transition-all duration-300">
                </a>
                ...
                <div class="flex items-center gap-2 lg:gap-4">
                    ...
                    <button onclick="openFeedbackModal()"
                        class="hidden lg:inline-flex items-center px-4 py-2 text-slate-600 font-semibold hover:text-yellow-700 hover:bg-yellow-50 rounded-lg hover:-translate-y-1 hover:shadow-lg transition-all duration-300 animate-fade-in-down animation-delay-200">
                        <svg class="w-5 h-5 mr-1 transition-transform duration-300 group-hover:rotate-12" fill="none"
                    ...
                    <a href="{{ route('schedules.index') }}"
                        class="hidden lg:inline-flex items-center px-4 py-2 text-yellow-600 font-semibold hover:text-yellow-700 hover:bg-yellow-50 rounded-lg hover:-translate-y-1 hover:shadow-lg transition-all duration-300 animate-fade-in-down animation-delay-300">
                        <svg class="w-5 h-5 mr-1 transition-transform duration-300 group-hover:scale-110" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    @auth
                        <a href="{{ route('dashboard') }}"
                            class="px-4 lg:px-6 py-2 border-2 border-yellow-500 text-yellow-600 font-semibold rounded-lg hover:bg-yellow-500 hover:text-white hover:shadow-xl hover:scale-110 transition-all duration-300 text-sm lg:text-base whitespace-nowrap animate-fade-in-down animation-delay-400">
                            Dashboard
                        </a>
                    @else
                        <a href="{{ route('login') }}"
    ...
    @if(session('success'))
        <div
            class="bg-green-50 border-l-4 border-green-500 text-green-800 px-6 py-4 mx-4 lg:mx-8 mt-4 rounded-r-lg shadow-sm animate-pulse">
    ...
    <section class="relative bg-yellow-500 text-white overflow-hidden">
        <div class="container mx-auto px-4 lg:px-8 py-12 lg:py-24 relative z-10">
            <div class="max-w-4xl mx-auto text-center">
                <h2
                    class="text-3xl lg:text-5xl font-bold mb-3 lg:mb-6 leading-tight drop-shadow-md animate-fade-in-up animation-delay-100">
                    Jadwal & Manajemen<br class="hidden lg:block" /> Laboratorium dan Fasilitas Digital
                </h2>
                <p
                    class="text-base lg:text-xl text-yellow-50 max-w-2xl mx-auto drop-shadow mb-6 lg:mb-10 animate-fade-in-up animation-delay-200">
                ...
                <div class="max-w-4xl mx-auto">
                    ...
                    <div class="space-y-3 animate-fade-in-up animation-delay-400">
                        @foreach($announcements as $announcement)
                            ...
                            @endphp
                            <div
                                class="bg-white rounded-xl shadow-sm border border-slate-200 border-l-4 {{ $config['border'] }} p-4 lg:p-5 hover:shadow-md transition-shadow">
                                <div class="flex items-start gap-3">
                                    <!-- Icon -->
                                    <div class="flex-shrink-0 mt-0.5">
                                        @if($announcement->type === 'penting')
                                            <svg class="w-5 h-5 {{ $config['icon_color'] }}" fill="currentColor"
                                                viewBox="0 0 20 20">
                                                <path fill-rule="evenodd"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center gap-2 mb-1">
                                            <span
                                                class="inline-flex px-2 py-0.5 text-xs font-bold rounded-full {{ $config['badge_bg'] }} {{ $config['badge_text'] }}">
                                                {{ $config['label'] }}
                                            </span>
                                            <span
                                                class="text-xs text-slate-400">{{ $announcement->created_at->format('d M Y') }}</span>
                                        </div>
                                        <h3 class="font-bold text-slate-800 text-sm lg:text-base">{{ $announcement->title }}
                                        </h3>
        ...
        <div class="container mx-auto px-4 lg:px-8">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="text-center mb-8">
                    <div
                        class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-red-500 to-red-600 rounded-full mb-4 shadow-lg">
                    ...
                    <form onsubmit="return handleDownloadSubmit(event)">
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" id="booking_token" name="booking_token"
                                    ...
                                    placeholder="Contoh: ABC123XYZ456" required maxlength="50">
                            </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-lg w-full mx-4 transform transition-all">
            ...
            <div class="flex items-center justify-between p-6 border-b border-gray-100">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Sampaikan masalah atau feedback Anda. Tim kami akan meninjau
                            laporan Anda.</p>
                    </div>
                </div>
            ...
            <form action="{{ route('feedback.store') }}" method="POST" class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="feedback_title" name="title" placeholder="Masukkan judul laporan" required
                ...
                <div>
                    ...
                    <textarea id="feedback_detail" name="detail" rows="5" placeholder="Jelaskan detail laporan Anda..."
                        required
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition resize-none"></textarea>
                </div>
    ...
    <footer class="bg-slate-800 text-slate-400 py-5">
        <div class="container mx-auto px-4 lg:px-8 text-center">
            ...
            <div class="flex flex-wrap items-center justify-center gap-4 lg:gap-6 mb-4 text-sm">
                ...
                <!-- Email -->
                <a href="mailto:labdigital@feb.ac.id"
            ...
            <!-- Copyright -->
            <p class="text-sm lg:text-base">&copy; {{ date('Y') }} Laboratorium dan Fasilitas Digital FEB UNDIP. All
                rights reserved.</p>
        </div>
    </footer>
