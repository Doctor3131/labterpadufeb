    ...
    <div class="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            @if($booking->status === 'approved')
                <a href="{{ route('booking.print', $booking->tracking_token) }}" target="_blank" class="w-full sm:w-auto bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-lg font-semibold text-center shadow-lg transition-colors flex items-center justify-center gap-2">
