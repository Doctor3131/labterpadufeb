...
<head>
    ...
    <title>{{ $request->isWalkIn() ? 'Pendaftaran' : 'Reservasi' }} Berhasil - Bloomberg FEB UNDIP</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>
<body class="bg-gradient-to-br from-slate-50 via-indigo-50 to-slate-100 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="max-w-2xl w-full">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-green-500 to-green-600 p-8 text-center">
                ...
                <h1 class="text-2xl lg:text-3xl font-bold text-white mb-2">{{ $request->isWalkIn() ? 'Pendaftaran' : 'Reservasi' }} Berhasil Dikirim!</h1>
                <p class="text-green-100">{{ $request->isWalkIn() ? 'Pendaftaran kunjungan langsung' : 'Reservasi' }} Bloomberg Terminal Anda telah kami terima</p>
            </div>
            ...
            <div class="p-6 lg:p-8">
                ...
                <div class="bg-gray-50 rounded-xl p-6 mb-6">
                    <h2 class="font-bold text-gray-800 mb-4 flex items-center">
                        ...
                        Ringkasan {{ $request->isWalkIn() ? 'Kunjungan' : 'Reservasi' }}
                    </h2>
                    ...
                    <div class="space-y-3 text-sm">
                        ...
                        <div class="flex justify-between py-2 border-b border-gray-200">
                            ...
                            <span class="font-medium text-gray-800">{{ $request->applicant_type_label }}</span>
                        </div>
                        ...
                        <div class="flex justify-between py-2 border-b border-gray-200">
                            <span class="text-gray-600">Tanggal Penggunaan</span>
