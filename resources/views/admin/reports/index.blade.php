    ...
    <div class="bg-white rounded-2xl shadow-lg mb-6 overflow-hidden">
        ...
        <form id="filter-form" class="p-4 md:p-6">
            ...
            <div class="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-100">
                ...
                <a href="#" id="btn-export-word" class="{{ $reportType === 'bloomberg' ? 'hidden' : 'flex' }} flex-1 sm:flex-none px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-all shadow-md hover:shadow-lg items-center justify-center">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
