            ...
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-2 md:space-x-3">
                    ...
                    <div class="hidden md:block">
                         <h1 class="text-sm font-bold text-gray-800 leading-tight">UPK FEB UNDIP</h1>
                         <p class="text-[10px] text-gray-500 font-medium">Sistem Peminjaman Laboratorium</p>
                    </div>
                </div>
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6 md:mb-8">
            ...
            <div class="flex flex-wrap items-center gap-2 md:gap-3 w-full md:w-auto mt-2 md:mt-0">
                 @if($booking->status === 'pending')
                    <span class="inline-flex items-center px-3 py-1.5 md:px-4 md:py-2 rounded-full text-xs md:text-sm font-semibold bg-yellow-100 text-yellow-800 border border-yellow-200 shadow-sm w-full md:w-auto justify-center md:justify-start mb-2 md:mb-0 md:inline-flex">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="px-4 md:px-6 py-3 md:py-4 border-b border-gray-50 bg-gray-50/50">
                    ...
                    <div class="p-4 md:p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <p class="text-base md:text-lg font-medium text-gray-900">{{ $booking->laboratory->name }}</p>
                        </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden min-h-[300px]">
                    <div class="px-6 py-5 border-b border-gray-100 flex justify-between items-center">
                        <h2 class="font-bold text-lg text-gray-800">Detail Kegiatan</h2>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-6">
                         <div class="flex items-center justify-between p-4 bg-blue-50 rounded-xl border border-blue-100 group hover:border-blue-200 transition-colors">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="font-semibold text-gray-900 group-hover:text-blue-700 transition-colors">Dokumen PDF</p>
                                    <p class="text-xs text-blue-600/70">Klik tombol di samping untuk mengunduh</p>
                                </div>
                            </div>
                            <a href="{{ asset('storage/' . $booking->document_path) }}" target="_blank" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-lg shadow transition-all flex items-center">
