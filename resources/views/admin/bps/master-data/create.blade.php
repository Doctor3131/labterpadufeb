...
@section('title', 'Tambah Kategori BPS - Laboratorium dan Fasilitas Digital FEB UNDIP')
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label class="flex items-center">
                        <input type="checkbox" name="has_sub_data" value="1" {{ old('has_sub_data', true) ? 'checked' : '' }}
