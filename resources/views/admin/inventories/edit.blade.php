...
@section('title', 'Edit Alat - Laboratorium dan Fasilitas Digital FEB UNDIP')
...
@section('content')
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-600">Perbarui informasi alat laboratorium</p>
        </div>
            ...
            <form action="{{ route('admin.inventories.update', $inventory->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="item_code" id="item_code" value="{{ old('item_code', $inventory->item_code) }}" required
                    ...
                    <div>
                        ...
                        <input type="number" name="quantity" id="quantity" value="{{ old('quantity', $inventory->quantity) }}" required min="0"
                    ...
                    <div>
                        ...
                        <select name="condition" id="condition" required
                            ...
                            <option value="Perbaikan" {{ old('condition', $inventory->condition) == 'Perbaikan' ? 'selected' : '' }}>Dalam Perbaikan</option>
                        </select>
                        @error('condition')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="number" name="price" id="price" value="{{ old('price', $inventory->price) }}" required min="0" step="0.01"
                    ...
                    <div>
                        ...
                        <input type="text" name="source" id="source" value="{{ old('source', $inventory->source) }}" required
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="4"
                            ...
                            placeholder="Spesifikasi teknis atau catatan tambahan...">{{ old('description', $inventory->description) }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
