...
@section('content')
    <div class="max-w-4xl mx-auto">
        ...
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Edit Ruang Lab</h1>
            <p class="text-sm text-gray-600">Perbarui detail ruang laboratorium</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="4"
                            ...
                            placeholder="Deskripsi fasilitas atau informasi tambahan tentang lab...">{{ old('description', $lab->description) }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
