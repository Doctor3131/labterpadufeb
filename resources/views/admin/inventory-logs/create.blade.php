...
@section('content')
    ...
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Catat Arus Barang</h1>
        <p class="text-sm text-gray-600">Catat informasi barang masuk atau keluar secara global.</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        <form action="{{ route('admin.inventory.logs.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <select name="flow" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 bg-white">
                        <option value="IN" {{ old('flow') === 'IN' ? 'selected' : '' }}>Barang Masuk</option>
                        <option value="OUT" {{ old('flow') === 'OUT' ? 'selected' : '' }}>Barang Keluar</option>
                    </select>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="recipient" value="{{ old('recipient') }}" required placeholder="Contoh: Pak Ilham, UPK, Dosen"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="items" rows="4" required placeholder="Contoh:&#10;HDMI 50M (5 unit)&#10;Kabel Power AIO (2 unit)"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500">{{ old('items') }}</textarea>
                ...
                <div class="md:col-span-2 p-4 border-2 border-dashed border-gray-300 rounded-lg bg-gray-50 text-center">
                    ...
                    ">
                    <p class="text-xs text-gray-500 mt-2">Format yang didukung: JPG, PNG (Maks. 2MB)</p>
                </div>
            </div>
