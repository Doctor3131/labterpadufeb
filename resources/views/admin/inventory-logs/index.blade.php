...
@section('title', 'Arus Barang - Laboratorium dan Fasilitas Digital FEB UNDIP')
                        ...
                        @foreach($logs as $log)
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center">
                                    @if($log->proof_file)
                                        <a href="{{ route('admin.secure-file', ['path' => $log->proof_file]) }}" target="_blank" class="inline-flex items-center p-2 text-blue-600 bg-blue-50 rounded hover:bg-blue-100 transition-colors" title="Lihat Bukti">
