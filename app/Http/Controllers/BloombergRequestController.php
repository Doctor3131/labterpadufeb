...
class BloombergRequestController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $isLecturer = in_array($applicantType, ['dosen_undip', 'dosen_non_undip']);
        ...
        $rules = [
            ...
            'usage_date' => [
                ...
                function ($attribute, $value, $fail) {
                    if (BlockedDate::isBlocked('bloomberg', $value)) {
                        $fail('Tanggal yang dipilih tidak tersedia untuk reservasi Bloomberg.');
                    }
                },
            ],
        ...
        if (!$isLecturer && $request->input('study_program') === 'Lainnya') {
        ...
        try {
            ...
            $nimNip = $isLecturer ? $validated['nip'] : $validated['nim'];
            ...
            DB::transaction(function () use ($token, $isWalkIn, $validated, $nimNip, $studyProgram, $statementPath) {
